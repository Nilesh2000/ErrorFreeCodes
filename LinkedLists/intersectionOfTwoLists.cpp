...
int main(void)
{
    ...
    Head1 -> Next -> Next -> Next -> Next = Head2 -> Next -> Next; //The address for the data 15 should be same in both the lists.
    ...
    insertAtEnd(Head2, 10);
    insertAtEnd(Head2, 15);
    Head1 -> Next -> Next -> Next = Head2 -> Next -> Next; //The address for the data 15 should be same in both the lists.
    insertAtEnd(Head2, 25);

    //T3 (c1 < c2)
    //List 1 : 3 15
    //List 2 : 10 15 25 35 45 55 65
    insertAtEnd(Head1, 3);
    insertAtEnd(Head1, 15);
    insertAtEnd(Head2, 10);
    insertAtEnd(Head2, 15);
    Head1 -> Next -> Next = Head2 -> Next -> Next; //The address for the data 15 should be same in both the lists.
    insertAtEnd(Head2, 25);
