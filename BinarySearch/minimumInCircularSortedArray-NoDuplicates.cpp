...
Given such an array, find the value of k and the smallest element in the array.
...
int main(void)
{
    ...
    cout << "Number of rotations : " << findRotationCount(V);
    cout << "\nMinimum Element : " << V[findRotationCount(V)];
    return 0;
}
